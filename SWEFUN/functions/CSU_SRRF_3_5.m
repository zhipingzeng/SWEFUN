...
for ii=1:100;   % 插值运算
    ...
    for xx=6:495;
        ...
        p_AAA=(v_frame_T(xx,yy)-ave1).^5*(v_frame(xx,yy)-ave0)/(200^3);  %换成相加或相乘
...
% write(t,cumulant3);
% close(t)
cumulant3_5=power(cumulant3,1/1);
cumulant3_5=int32(cumulant3_5);
save('cumulant3_5.mat','cumulant3_5');
% disp('5');
% toc
