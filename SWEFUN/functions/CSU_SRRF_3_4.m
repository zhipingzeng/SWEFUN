...
for ii=1:100;   % 插值运算
    ...
    for xx=6:495;
        ...
        p_AAA=(v_frame_T(xx,yy)-ave1).^4*(v_frame(xx,yy)-ave0).^2/(200^3);  %换成相加或相乘
...
% write(t,cumulant3);
% close(t)
cumulant3_4=power(cumulant3,1/1);
cumulant3_4=int32(cumulant3_4);
save('cumulant3_4.mat','cumulant3_4');
% disp('4');
% % toc
