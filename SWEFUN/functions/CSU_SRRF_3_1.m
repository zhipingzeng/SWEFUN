...
% filename0=strcat('C:\Zhiping Zeng\FUZHOU UNIV 2\Simultaneous Multicolor SRRF -2020\8-color\RawData\stack\stack_R.tif');
stack=app.filename0;
I=Tiff(stack,'r');
...
% filename1=strcat('C:\Zhiping Zeng\FUZHOU UNIV 2\Simultaneous Multicolor SRRF -2020\8-color\RawData\stack\stack_T.tif');
stack=app.filename1;
I=Tiff(stack,'r');
img=zeros(500,500,100);
for kk=1:100;
...
for ii=1:100;   % 插值运算
    ...
    for xx=6:495;
        ...
        p_AAA=(v_frame_T(xx,yy)-ave1)*(v_frame(xx,yy)-ave0).^5/(200^3);  %换成相加或相乘
...
% imshow(cumulant3,[])
% imshow(uint16(cumulant3)*app.strengthen,'Parent',app.CSUSRRF);pause(0.01)
...
% write(t,cumulant3);
% close(t)
cumulant3_1=power(cumulant3,1/1);  %1/7
cumulant3_1=int32(cumulant3_1);
save('cumulant3_1.mat','cumulant3_1');
% disp('1');
% toc
