...
for ii=1:100;   % 插值运算
    ...
    for xx=6:495;
        ...
        p_AAA=(v_frame_T(xx,yy)-ave1).^2*(v_frame(xx,yy)-ave0).^4/(200^3);  %换成相加或相乘
...
% write(t,cumulant3);
% close(t)
cumulant3_2=power(cumulant3,1/1);
cumulant3_2=int32(cumulant3_2);
save('cumulant3_2.mat','cumulant3_2');
% disp('2');
% toc
